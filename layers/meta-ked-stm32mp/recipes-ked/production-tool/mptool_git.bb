...
SRC_URI = "git://${KED_GIT_SERVER}/sw/misc/apps/mptool.git;protocol=ssh;branch=${SRCBRANCH}"
SRC_URI_http = "git://${KED_GIT_SERVER}/sw/misc/apps/mptool.git;protocol=http;branch=${SRCBRANCH}"
